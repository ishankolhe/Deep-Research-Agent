...
def write_deep_report(query: str, research_results: list[dict],
    ...
    part4 = generate_text(
        ...
        "'## Research Gaps and Future Directions' — what remains genuinely unknown "
        "based on the facts gathered (not generic 'more research is needed').\n"
        ...
        "Low), the single strongest piece of evidence for your answer, the biggest "
        "remaining uncertainty, and the most important unresolved question."
    )
